FROM --platform=linux/amd64 ubnt/unms:1.4.4 as unms
FROM --platform=linux/amd64 ubnt/unms-nginx:1.4.4 as unms-nginx
FROM --platform=linux/amd64 ubnt/unms-netflow:1.4.4 as unms-netflow
FROM --platform=linux/amd64 ubnt/unms-crm:3.4.4 as unms-crm
FROM --platform=linux/amd64 ubnt/unms-siridb:1.4.4 as unms-siridb
FROM --platform=linux/amd64 ubnt/unms-postgres:1.4.4 as unms-postgres
