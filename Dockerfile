FROM ubnt/unms:1.3.4 as unms
FROM ubnt/unms-nginx:1.3.4 as unms-nginx
FROM ubnt/unms-netflow:1.3.4 as unms-netflow
FROM ubnt/unms-crm:3.3.4 as unms-crm
FROM ubnt/unms-siridb:1.3.4 as unms-siridb
