...
FROM ubnt/unms:1.1.3 as unms
FROM ubnt/unms-nginx:1.1.3 as unms-nginx
FROM ubnt/unms-netflow:1.1.3 as unms-netflow
FROM ubnt/unms-crm:3.1.3 as unms-crm
