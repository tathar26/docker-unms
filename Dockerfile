...
FROM ubnt/unms:1.1.4 as unms
FROM ubnt/unms-nginx:1.1.4 as unms-nginx
FROM ubnt/unms-netflow:1.1.4 as unms-netflow
FROM ubnt/unms-crm:3.1.4 as unms-crm
